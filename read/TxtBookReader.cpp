...
TxtBookReader::TxtBookReader(shared_ptr<ZLFile> &file, const std::string &title, const std::string &encoding,
                             const std::string &language, const std::string &cacheDir, const PlainTextFormat &format)
        : TxtReader(encoding), BookReader(file,title,encoding,language,cacheDir), myFormat(format)
{}
